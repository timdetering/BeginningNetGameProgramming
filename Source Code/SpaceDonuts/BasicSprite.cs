...
namespace SpaceDonuts
{
    ...
    public class BasicSprite
    {
        ...
        {
            get { return durationEnded; }
            set { durationEnded = value; }
        }

        public bool VisuallyRotates
        {
            get { return visuallyRotates; }
            set { visuallyRotates = value; }
        }
        ...
        public float Angle
        {
            get { return Geometry.RadianToDegree(zAngle); }
            set { zAngle = Geometry.DegreeToRadian(value); }
        }

        public int CollisionxExtent
        {
            get { return collisionxExtent; }
            set { collisionxExtent = value; }
        }

        public int CollisionyExtent
        {
            get { return collisionyExtent; }
            set { collisionyExtent = value; }
        }
        ...
        public virtual void Draw(Sprite d3dSprite)
        {
            if (isVisible)
            {
                ...
                //Spin, Shift, Stretch :-)
                d3dSprite.Transform = Matrix.RotationZ(visualAngle) * Matrix.Translation(center) *
